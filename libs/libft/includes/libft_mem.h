...
*/
void
*ft_memccpy(void *restrict dest, const void *restrict src, uint8_t c, size_t n);
...
*/
void
*ft_memmove(void *restrict dest, const void *restrict src, size_t len);
...
*/
extern void
ft_bzero(void *restrict s, size_t n);

/*
**	Free memory at pointer \param ap.
*/
extern void
ft_memdel(void *restrict *restrict ap);
...
*/
void
*ft_memrealloc(void *restrict ptr, size_t old_size, size_t new_size);

/*
**	Creating duplicate of \param src on heap.
*/
extern void
*ft_memdup(const void *restrict src, size_t size);
...
*/
extern void
ft_memswap(void *restrict a, void *restrict b, size_t len);
